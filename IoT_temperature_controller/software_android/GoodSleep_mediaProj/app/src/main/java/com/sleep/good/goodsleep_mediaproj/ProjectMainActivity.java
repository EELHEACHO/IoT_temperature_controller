...
public class ProjectMainActivity extends AppCompatActivity {
    ...
    FragmentRoomHeating roomHeatingFragment;
    FragmentFloorHeating floorHeatingFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomHeatingFragment = new FragmentRoomHeating();
        floorHeatingFragment = new FragmentFloorHeating();


        getSupportFragmentManager().beginTransaction().replace(R.id.container, roomHeatingFragment).commit();
        ...
        tabs.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(position==0){
                    getSupportFragmentManager().beginTransaction().replace(R.id.container, roomHeatingFragment).addToBackStack(null).commit();
                } else if(position==1){
                    getSupportFragmentManager().beginTransaction().replace(R.id.container, floorHeatingFragment).addToBackStack(null).commit();
                } else if(position==2){
                    Intent intent = new Intent(ProjectMainActivity.this, ShowDataActivity.class);
        ...
        icOptionIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProjectMainActivity.this, UserInfoActivity.class);
                startActivity(intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.icAlarm:
                Intent intent = new Intent(ProjectMainActivity.this, AlarmActivity.class);
                startActivity(intent);
                return true;
            default:
    ...
    protected void showSetAddressDialog(){
        LayoutInflater current_layout = LayoutInflater.from(ProjectMainActivity.this);
        View dialog_view = current_layout.inflate(R.layout.set_address_dialog, null);
        final AlertDialog.Builder alert_dialog_builder = new AlertDialog.Builder(ProjectMainActivity.this);
        ...
        alert_dialog_builder.setCancelable(false).setPositiveButton("예", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                try{
                    Intent intent = new Intent(ProjectMainActivity.this, SetAddressActivity.class);
                    startActivity(intent);
                }catch(Exception e){
                    e.printStackTrace();
                }
                                ...
                                if(b == mCharDelimiter) {
                                    ...
                                    handler.post(new Runnable(){
                                        ...
                                        public void run() {
                                            ...
                                            text.setText(text.getText().toString() + data + mStrDelimiter);
                                        }
                                    });
                                }
                                else {
